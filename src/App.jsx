...
const css = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .nav-logo{font-family:'Montserrat',sans-serif;;font-weight:600;letter-spacing:-.5px}.nav-logo span{color:var(--gold)}
